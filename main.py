...
class Line:  # класс линии, принимает координаты начальной и конечной точек, толщину и цвет кисти
...
class Circle:  # класс эллипса, принимает координаты начальной и конечной точек, разрешение на заливку,
...
class Triangle:  # класс треугольника, принимает координаты начальной и конечной точек, разрешение на заливку,
    # толщину и цвет контура, а также цвет заливки
    def __init__(self, sx, sy, x, y, fill, size, color, color_2):
...
class Rectangle:  # класс прямоугольника, принимает координаты начальной и конечной точек, разрешение на
...
class Pentagon:  # класс пятиугольника, принимает координаты начальной и конечной точек, разрешение на заливку,
    # толщину и цвет контура, а также цвет заливки
    def __init__(self, sx, sy, x, y, fill, size, color, color_2):
...
class Hexagon:  # класс шестиугольника, принимает координаты начальной и конечной точек, разрешение на заливку,
    # толщину и цвет контура, а также цвет заливки
    def __init__(self, sx, sy, x, y, fill, size, color, color_2):
...
class Octagon:  # класс восьмиугольника, принимает координаты начальной и конечной точек, разрешение на заливку,
    # толщину и цвет контура, а также цвет заливки
    def __init__(self, sx, sy, x, y, fill, size, color, color_2):
